...
class ProductController:
    ...
    def register_product():
        try:
            ...
            # Obtém o ID do vendedor via token JWT
            ...
            return make_response(jsonify({
                ...
                "produto": product.to_dict()  # inclui o ID aqui!
            }), 201)
    ...
    def inativar_product(id):
        try:
            ...
            # Verifica se o produto é do vendedor logado
            if str(product.seller_id) != str(current_seller_id):
                return make_response(jsonify({"erro": "Não autorizado. Você não é o vendedor deste produto."}), 403)
            ...
            return make_response(jsonify({
                ...
                "produto": inactivated_product.to_dict()  # ID continua sendo retornado
            }), 200)
